                    ...
                    @foreach ($posts as $post)
                        <div class="col-md-6 col-lg-4 mb-3">
                            <article class="post-card">
                                <a href="{{ route('blog.show', $post->slug) }}" class="d-block position-relative overflow-hidden" style="background-image: url({{ $post->thumbnail ? $post->thumbnail->size('medium_large')['url'] : '' }})">
